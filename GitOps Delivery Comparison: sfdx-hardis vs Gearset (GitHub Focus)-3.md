...
sfdx-hardis provides a **separate Org Monitoring feature** that creates a dedicated Git repository for daily metadata backups. This is **distinct from the CI/CD repository** but complements it.
